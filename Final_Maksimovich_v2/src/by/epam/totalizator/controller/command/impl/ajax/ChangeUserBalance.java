 ...
 */
public class ChangeUserBalance implements ICommand {
	...
	private static final String SUCCESS_MESSAGE_KEY = "local.ajax.change_user_balance.success";
	...
	/**
	 * Performs a service level call to change the balance of the user by the
	 * amount
	 * 
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			factory.getClientService().changeUserBalance(idUser, amount);
