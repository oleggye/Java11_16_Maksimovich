...
import by.training.analyser.service.util.ErrorConstants;
...
public class AnalyseServiceImpl implements AnalyseService {
	...
	public void initialize(String fileName) throws ServiceException {
		...
		try {
			...
			throw new ServiceException(ErrorConstants.ERROR_DURING_INIT_MESSAGE, e);
		}
	...
	public Node next() throws ServiceException {
		...
		if (xmlDAO == null) {
			throw new ServiceException(ErrorConstants.UNINITIALIZED_SERVICE_MESSAGE);
		}
		...
		if (nodeData != null) {
			...
			try {
				...
				throw new ServiceException(ErrorConstants.CLOSE_RESOURCE_MESSAGE, e);
			}
		}
	...
	private String getData() throws ServiceException {
		...
		try {
			...
			throw new ServiceException(ErrorConstants.HAS_NO_NEXT_NODE_MESSAGE, e);
		}
