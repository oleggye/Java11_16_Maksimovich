...
public class GenerateAvailableEquipmentReport implements Command {

	private static final Logger logger = LogManager.getLogger(GenerateAvailableEquipmentReport.class.getName());
	...
	public String execute(String request) {
		...
		try {
			equipmentList = shopService.getAvailableEquipmentReport();
