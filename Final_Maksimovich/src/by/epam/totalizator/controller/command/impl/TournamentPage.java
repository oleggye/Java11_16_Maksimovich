...
public class TournamentPage implements ICommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			page = ConfigurationManager.getProperty(PageKeyStore.TOUENAMENT_PAGE_KEY);
	...
	private boolean isUserTypeClient(UserType userType) {
		return UtilClass.isUserTypeClient(userType);
	}
	...
	/**
	 * Method sets the refresh rate of the page
	 * 
	 * @param response {@link HttpServletResponse}
	 */
	private void setPageRefreshTime(HttpServletResponse response){
		response.setIntHeader("Refresh", REFRESH_TIME_S);
	}
}