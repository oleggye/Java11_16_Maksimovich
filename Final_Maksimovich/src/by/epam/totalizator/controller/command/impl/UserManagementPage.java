...
public class UserManagementPage implements ICommand {
	 ...
	 */
	private static final int RECORD_QUANTITY_PER_PAGE = 7;
	/**
	 ...
	 * {@link User} and obtain user count.
	 * 
	 * Sets these objects and {@link #COMPETITION_MANAGEMENT_COMMAND} to the
	 * request and formed {@link #COMMAND_URL_PATTERN} to the user's session as
	 * attributes.
	 * 
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			page = ConfigurationManager.getProperty(PageKeyStore.USER_MANAGEMENT_PAGE_KEY);
