		...
		if (login != null) {
			...
			try {
				...
				if (isLoginReserved) {
					...
					String message = LocalizationBundle.getInstance().getProperty(user.getLocale(),
							EMAIL_IN_USE_ERROR_KEY);
					request.setAttribute(AttributeNameStore.ATTRIBUTE_ERROR_LOGIN_MESSAGE, message);
