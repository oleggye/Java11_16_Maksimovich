...
public class BanUser implements ICommand {
	...
	private static final String SUCCESS_MESSAGE_KEY = "local.ajax.ban_user";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			factory.getClientService().banUser(idUser);
	...
	private int getIdUser(HttpServletRequest request) {
		return Integer.valueOf(request.getParameter(ParamNameStore.PARAM_NAME_ID_USER));
	}
