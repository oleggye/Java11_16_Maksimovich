...
public class SQLProvider {
	...
	private SQLProvider() {
		...
		sqlRepository.put(SQLName.CHANGE_BETTING_STATUS, BettingSQLStore.CHANGE_BETTING_STATUS);
		...
		sqlRepository.put(SQLName.CALL_CHANGE_USER_BALANCE, UserSQLStore.CALL_CHANGE_USER_BALANCE);
		sqlRepository.put(SQLName.UPDATE_USER_TYPE, UserSQLStore.UPDATE_USER_TYPE);
	...
	/**
	 * Method which return certain string with querier
	 * 
	 * @param sqlName
	 *            a instance of {@link SQLName}
	 * @return the string with querier
	 */
