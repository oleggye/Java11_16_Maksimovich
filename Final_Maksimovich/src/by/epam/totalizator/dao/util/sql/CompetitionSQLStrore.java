...
/**
 * Class contains strings with querier for {@link #Competition}
 */
public final class CompetitionSQLStrore {
	...
	// + "where competition.start_time > NOW() and competition.is_prepared='1'
	// and competition.status='A' order by competition.start_time desc Limit
	// ?,?;";
	...
	// + "where competition.id_sport = ? and competition.id_tournament = ? and
	// competition.start_time > NOW() and competition.is_prepared='1' and
	// competition.status='A' order by competition.start_time desc Limit ?,?;";
