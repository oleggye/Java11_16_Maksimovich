...
public final class CompetitionBuilder {
	...
	// public void buildCompetition(int id, Sport sport, Tournament tournament,
	// Team homeTeam, Team awayTeam,
	// Country country, Date startTime, BigDecimal winHomeRate, BigDecimal
	// drawRate, BigDecimal winAwayRate,
	// Result result) {
	//
	// }
	...
	public void buildStartTime(Timestamp timestamp) {
		LocalDateTime dateTime = timestamp.toLocalDateTime();

		competition.setStartTime(dateTime);
		competition.setDate(new Date(timestamp.getTime()));
	}
