	...
	<div class="vertical-menu">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="controller?command=tournament-page&idsport=1&idtourn=1">
					<c:out value="${champligue}" />
				</a> <a href="controller?command=tournament-page&idsport=1&idtourn=2">
					<c:out value="${europligue}" />
				</a> <a href="controller?command=tournament-page&idsport=1&idtourn=3"><c:out
						value="${spainprimera}" /></a> <a
					href="controller?command=tournament-page&idsport=1&idtourn=4"><c:out
						value="${engprimier}" /></a>
			</div>
		</div>
		<p />
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="controller?command=tournament-page&idsport=2&idtourn=5"><c:out
						value="${daviscup}" /></a>
			</div>
		</div>
		<p />
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="controller?command=tournament-page&idsport=3&idtourn=6">
					<c:out value="${nba}" />
				</a> <a href="controller?command=tournament-page&idsport=3&idtourn=7">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="controller?command=tournament-page&idsport=4&idtourn=8">
					<c:out value="${nhl}" />
				</a> <a href="controller?command=tournament-page&idsport=4&idtourn=9">
					<c:out value="${khl}" />
				</a>
			</div>
		</div>
