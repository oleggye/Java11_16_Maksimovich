				...
				<form action="controller" method="post">
					...
					<div class="form-group">
						<label for="email-field"><c:out value="${email}" /></label> <input
							...
							placeholder="Enter email" value="admin@example.com" required>
					</div>
					<div class="form-group">
						<label for="password-field"><c:out value="${password}" /></label>
						<input type="password" class="form-control" name="password"
							id="password-field" placeholder="Enter password" value="123"
							required>
					</div>
					<%-- <div class="checkbox">
					...
					<button type="submit" class="btn btn-default ">
						...
						<div class="addition">
							<a href="controller?command=signUp-page"><c:out value="${signUp}" /></a> <br> 
							<%-- <a
