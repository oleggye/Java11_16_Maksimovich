...
<body>
	...
	<fmt:message bundle="${localBundle}" key="local.signup.city" var="city" />
	<fmt:message bundle="${localBundle}"
		key="local.signup.city.place_holder" var="cityPlaceHolder" />
	<fmt:message bundle="${localBundle}" key="local.signup.city.title"
		var="cityTitle" />
			...
			<div class="col-sm-4 text-left signupmain"
				...
				<form name="signInForm" action="controller"
					...
					<div class="form-group">
						<label for="first-name-field"><c:out value="${firstName}" /></label>
					...
					<div class="form-group">
						<label for="last-name-field"><c:out value="${lastName}" /></label>
						<span class="req-symbol">*</span> <input class="form-control"
					...
					<div class="form-group">
						<label for="city-field"><c:out value="${city}" /></label> <span
							class="req-symbol">*</span> <input class="form-control"
							type="text" name="city" id="city-field" value=""
							pattern="^[A-Za-zА-Яа-я]{3,14}" placeholder="${cityPlaceHolder}"
							title="${cityTitle}" onchange="checkCityField(this)" required>
					...
					<div class="form-group">
						...
						<span class="req-symbol">*</span> <input
							class="form-control mx-sm-3" type="text" name="date"
